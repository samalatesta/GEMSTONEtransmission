...
import "task_gubbins.wdl" as gubbins_task
import "task_iqtree2.wdl" as iqtree2_task
import "task_reorder_matrix.wdl" as reorder_matrix_task
import "task_snippy_core.wdl" as snippy_core_task
import "task_snp_dists.wdl" as snp_dists_task
import "task_cat_files.wdl" as file_handling
import "task_shared_variants.wdl" as shared_variants_task
import "task_snp_sites.wdl" as snp_sites_task
import "task_versioning.wdl" as versioning
import "task_summarize_data.wdl" as data_summary
...
workflow snippy_tree_wf {
  ...
  output {
    ...
    File? snippy_gubbins_final_tree = gubbins.gubbins_final_tree
    File? snippy_gubbins_polymorphic_fasta = gubbins.gubbins_polymorphic_fasta
    File? snippy_gubbins_final_labelled_tree = gubbins.gubbins_final_labelled_tree
